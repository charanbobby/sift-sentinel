...
- ⬜ Next: Slice 5 Steps 1–12 per [slice-5-runbook.md](../runbooks/slice-5-runbook.md). Module extraction bundled into this slice's Step 1 + 7. R_06 enhancement + R_13 real body land with Slice 5's structured-metadata surface.
